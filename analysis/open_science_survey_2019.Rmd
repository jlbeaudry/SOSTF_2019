...
In terms of Field of Research Codes, we had at least one response from respondents who classified themselves as belonging to the two-digit FOR codes from 01 to 20, one person indicated "Other", and `r FOR_freq[20,2]` respondents did not specify their FOR code. We did not have any responses from researchers in History and Archeology (21) and Philosophy and Religious Studies (22). For ease of interpretation and to reduce the identifiability of the respondents, we classified similar FOR codes with a small number of respondents (less than 10) into disciplinary groups. Specifically, the new discipline grouping of Arts, Social Sciences, and Humanities (ASSH) included Education (13, <em>n</em> = `r FOR_freq[6,2]`), Studies in Human Society (16, <em>n</em> = `r FOR_freq[18,2]`), Studies in Creative Arts and Writing (19, <em>n</em> = `r FOR_freq[17,2]`), and Language, Communication and Culture (20, <em>n</em> = `r FOR_freq[10,2]`). The new discipline grouping of Business & Law included Economics (14, <em>n</em> = `r FOR_freq[5,2]`), Commerce, Management, Tourism, and Services (15, <em>n</em> = `r FOR_freq[4,2]`), and Law and Legal Studies (18, <em>n</em> = `r FOR_freq[11,2]`). The new discipline grouping of Technology & Computer Sciences included Information and Computing Sciences (08, <em>n</em> = `r FOR_freq[9,2]`), and Technology (10, <em>n</em> = `r FOR_freq[19,2]`). We retained the FOR codes of Engineering (09, <em>n</em> = `r FOR_freq[7,2]`), Medical & Health Sciences (11, <em>n</em> = `r FOR_freq[13,2]`), Physical Sciences (02, <em>n</em> = `r FOR_freq[15,2]`), and Psychology & Cognitive Sciences (17, <em>n</em> = `r FOR_freq[16,2]`) as their own discipline groupings. The breakdown for the number of respondents according to discpline groupings is displayed in the next table.
