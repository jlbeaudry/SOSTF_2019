...
output:
  word_document: 
   # fig_width: 12 # this works, but it changes the font of plot_ly, etc.
   # fig_height: 10 # so, don't use for now
...
options(scipen = 999)
options(kableExtra.auto_format = FALSE) # switch to 'false' for word doc; 'true' for pdf
...
```{r crisis_by_estimate_stripchart, echo = FALSE, include = TRUE, out.height=4, out.width=5}
