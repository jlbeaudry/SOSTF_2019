...
code_con_key <- c (CodeCon_criticise = "Others might criticise my materials/code", 
                     CodeCon_diff_understand = "Others might find it difficult to understand my 
                   materials/code",
...
# create a character vector for the colours for each bar
cols <- c("lightskyblue3", "lightskyblue3", "lightskyblue3", "lightskyblue3", "lightskyblue3", "lightskyblue3", "lightskyblue3", "lightskyblue3", "grey50")
