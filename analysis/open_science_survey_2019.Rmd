...
```{r code_count_use, echo=FALSE, warning=TRUE}
...
```{r data_count_use, echo=FALSE, warning=TRUE}
...
```{r prepub_imp_ex_pie_chart, echo = FALSE, warning = TRUE}
...
##### Use of Prepublication Archives

```{r prepub_count_use, echo=FALSE, warning=TRUE}
