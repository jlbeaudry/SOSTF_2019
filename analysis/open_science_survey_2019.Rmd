...
simple_bar_graph <- function (the_data, label_var = "", the_title = "", 
                              yname = "Percentage", xname = "Response",
...
we report the sample size for each question.

In terms of their demographics, we did not obtain information about gender or age
to provide more anonymity to our respondents. We did ask about their Academic 
Level or Type and their Discpline (based on 2-digit and 4-digit Field of Research [FOR] codes). 

<!--NEED TO RECODE THESE the AcLevel Variable & the FOR CODES. FOR NOW, I COULD
PULL IN THIS DATA FROM JORDY'S, BUT THAT'S LESS THAN IDEAL. EITHER WAY INSERT THESE
DETAILS HERE-->
