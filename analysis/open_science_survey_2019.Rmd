...
# code to save it in the figs folder. Increase 'base_size' from 12 to 18 for slides/pdf. 
...
ggsave(here::here("figs", "all_importance.png"), 
       width = 12, height = 6, dpi = "retina")
# change base_size to 12 for regular knit
```
...
ggsave(here::here("figs", "all_experience.png"), 
       width = 12, height = 6, dpi = "retina")
# change base_size to 12 for regular knit
```
...
# ggsave(here::here("figs", "all_barriers.png"), 
