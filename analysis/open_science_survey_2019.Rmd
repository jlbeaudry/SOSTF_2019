...
# filter rows with valid responses for this variable; first df contains all valid 
  # responses
  # the second df contains all valid responses, except "Researchers...do not conduct 
  # research studies"
...
tb_c_exp2 %>% 
knitr::kable (col.names = c("Reported Experience", "Frequency", "Percentage"), 
              caption = sprintf("Experience with Open Materials and/or Code (n = %d)", nvalid_code_exp), align = 'lcc') %>% 
    kable_styling(bootstrap_options = "striped", full_width = F, position = 'center',
                  font = 14)
