...
<!--NEED TO RECODE THE 'FOR' CODES. FOR NOW, I COULD PULL IN THIS DATA FROM JORDY'S, 
BUT THAT'S LESS THAN IDEAL. EITHER WAY INSERT THESE DETAILS HERE-->
...
```{r code_bar, echo = FALSE, warning = TRUE, eval = TRUE}
title = "What is your experience with open materials and/or code (n = %d)"

p <- simple_bar_graph(df, label_var = "CodeExp", the_title = title, xname = "Response given", bar_colour = "orange",line_colour = "black",the_quantity="count",include_NA="LAST")
p
```
...
colours <- brewer.pal(4, "Blues")
p <- simple_pie_chart(df,label_var="CodeExp",the_title = title, colours = colours, the_quantity="percent",include_NA="FIRST")
p
```
